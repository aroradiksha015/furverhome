            ...
            {pet ? (
              <>
                ...
                <div className="mb-3">
                  ...
                  <p className="form-control-plaintext">{pet?.petname || "N/A"}</p>
                </div>

                <div className="mb-3">
                  <label className="fw-bold">Type:</label>
                  <p className="form-control-plaintext">{pet?.type || "N/A"}</p>
                </div>

                <div className="mb-3">
                  <label className="fw-bold">Age:</label>
                  <p className="form-control-plaintext">{pet?.age || "N/A"}</p>
                </div>

                <div className="mb-3">
                  <label className="fw-bold">Description:</label>
                  <p className="form-control-plaintext">{pet?.description || "N/A"}</p>
                </div>

                <div className="mb-3">
                  <label className="fw-bold">NGO Name:</label>
                  <p className="form-control-plaintext">{pet?.ngoname || "N/A"}</p>
                </div>

                <div className="mb-3">
                  <label className="fw-bold">NGO Email:</label>
                  <p className="form-control-plaintext">{pet?.ngoemail || "N/A"}</p>
                </div>

                <div className="text-center">
                  {/* <button className="btn btn-success px-4">Adopt</button> */}
                  <Link className="btn btn-success" to={"/addRequest/"+pet?.id}>ADOPT</Link>
                </div>
              </>
            ) : (
