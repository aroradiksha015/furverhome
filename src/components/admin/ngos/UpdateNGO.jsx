...
export default function UpdateNGO(){
       const [name, setName]=useState("")
        ...
        const fetchData= async() => {
            let ngoDoc = await getDoc(doc(db,"users", id))
            let ngoData = ngoDoc.data();
            console.log(ngoData);
               setName(ngoData.name)
               setEmail(ngoData.email)
                setContact(ngoData.contact)
                setLicenseNO(ngoData.licenseNO)
                setAbout(ngoData.about)
                setAddress(ngoData.address)
                }
        ...
        <>
         <section
                ...
                <div className="row no-gutters slider-text align-items-end">
                    ...
                    <h1 className="mb-0 bread">Update NGO</h1>
                    </div>
                </div>
                </div>
            </section>
            <div className="container my-5">
                ...
                <div className="col-md-7" style={{boxShadow:"0px 0px 10px gray"}}>
                    ...
                    <h3 className="mb-4">Update NGO</h3>
                    <form
                        method="POST"
                        id="contactForm"
                        name="contactForm"
